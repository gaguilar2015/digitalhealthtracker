...
import type { SheetColumn, SheetColumnType, CreateSheetRow } from '@/types';
...
export function inferColumns(headers: string[], rows: unknown[][]): SheetColumn[] {
...
function inferType(sample: string[]): SheetColumnType {
...
export function convertCellValue(rawValue: unknown, type: SheetColumnType): unknown {
