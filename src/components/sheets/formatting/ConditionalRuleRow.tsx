...
import type { ConditionalFormatRule, ConditionalOperator, SheetColumnType, CellStyle } from '@/types';
...
const OPERATORS_BY_TYPE: Record<SheetColumnType, { value: ConditionalOperator; label: string }[]> = {
  text: [
