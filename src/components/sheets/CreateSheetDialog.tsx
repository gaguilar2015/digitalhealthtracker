...
import { sheetSchema } from '@/lib/utils/validation';
...
interface CreateSheetFormValues {
  name: string;
...
interface CreateSheetDialogProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (data: CreateSheetFormValues & { icon: string | null; group_id: string | null }) => Promise<void>;
...
export function CreateSheetDialog({ open, onClose, onSubmit, defaultGroupId }: CreateSheetDialogProps) {
  ...
  const handleFormSubmit = async (data: CreateSheetFormValues) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-surface-200 max-w-lg w-full p-6 max-h-[90vh] overflow-y-auto">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Create Sheet</h3>
