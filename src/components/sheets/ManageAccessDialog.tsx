...
import type { SheetMember, SheetGroupMember, TeamMember } from '@/types';
...
interface ManageAccessDialogProps {
  ...
  onRemoveMember: (sheetMemberId: string) => Promise<void>;
  groupName?: string;
  groupColor?: string;
  groupMembers?: SheetGroupMember[];
}

export function ManageAccessDialog({
  open, onClose, creatorId,
  sheetMembers, teamMembers,
  ...
  const memberIds = useMemo(
    () => new Set(sheetMembers.map(m => m.team_member_id)),
    [sheetMembers],
  );
