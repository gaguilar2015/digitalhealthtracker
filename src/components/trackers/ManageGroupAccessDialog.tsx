...
import type { TrackerGroupMember, TeamMember } from '@/types';

interface ManageGroupAccessDialogProps {
  open: boolean;
  onClose: () => void;
  groupId: string;
  groupName: string;
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-surface-200 max-w-md w-full p-6 max-h-[90vh] overflow-y-auto">
        ...
        <p className="text-xs text-gray-500 mb-4">
          Members added here get access to all trackers in this group.
        </p>
