...
import type { TrackerColumn, TrackerRow, CellStyle } from '@/types';

export interface TrackerRowComponentProps {
  row: TrackerRow;
  index: number;
...
/**
 * Renders the <td> cells for a tracker row.
 * Must be placed inside a <tr> element.
 */
export function TrackerRowComponent({
  row,
  index,
  columns,
  readOnly,
