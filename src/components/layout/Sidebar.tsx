...
import { LayoutDashboard, ClipboardList, GanttChart, FolderOpen, Table2, Workflow, Users, Activity, PanelLeftClose, PanelLeftOpen, ShieldCheck, Settings, LogOut, User } from 'lucide-react';
